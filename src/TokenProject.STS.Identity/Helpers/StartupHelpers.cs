...
using TokenProject.STS.Identity.Configuration;
using TokenProject.STS.Identity.Configuration.ApplicationParts;
using TokenProject.STS.Identity.Configuration.Constants;
using TokenProject.STS.Identity.Configuration.Interfaces;
using TokenProject.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace TokenProject.STS.Identity.Helpers
{
